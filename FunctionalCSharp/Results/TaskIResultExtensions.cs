...
namespace FunctionalCSharp.Results
{
  ...
  public static class TaskIResultExtensions
  {
    ...
    /// <param name="ifSuccess"></param>
    /// <returns></returns>
    public static async Task<IResult<TEnum>> BindAsync<TEnum>(this Task<IResult<TEnum>> @this, Func<IResult<TEnum>> ifSuccess) where TEnum : struct, Enum =>
      (await @this)
        .Bind(ifSuccess);
    ...
    /// <param name="ifSuccess"></param>
    /// <returns></returns>
    public static async Task<IResult<TEnum>> BindAsync<T, TEnum, TResult>(this Task<IResult<T, TEnum>> @this, Func<T, IResult<TEnum>> ifSuccess)
      where TEnum : struct, Enum =>
        (await @this)
          .Bind(ifSuccess);
    ...
    /// <param name="ifSuccessAsync"></param>
    /// <returns></returns>
    public static async Task<IResult<TEnum>> BindAsync<T, TEnum, TResult>(this Task<IResult<T, TEnum>> @this, Func<T, Task<IResult<TEnum>>> ifSuccessAsync)
      where TEnum : struct, Enum =>
        await (await @this)
          .BindAsync(ifSuccessAsync);
    ...
    public static async Task<IResult<TResult, TEnum>> BindAsync<T, TEnum, TResult>(this Task<IResult<T, TEnum>> @this,
      Func<T, IResult<TResult, TEnum>> ifSuccess) where TEnum : struct, Enum =>
        (await @this)
          .Bind(ifSuccess);
