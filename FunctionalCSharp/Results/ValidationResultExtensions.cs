...
namespace FunctionalCSharp.Results
{
  ...
  public static class ValidationResultExtensions
  {
    ...
    public static IResult<T> IsNotNull<T>(this T @this, string failureMessage) =>
      @this.IsNotNull() ? Result<T>.Success(@this) : Result<T>.Failure(failureMessage);
    ...
    public static IResult<T> IsNotDefault<T>(this T @this, string failureMessage) =>
      @this.IsNotDefault() ? Result<T>.Success(@this) : Result<T>.Failure(failureMessage);
    ...
    /// <param name="failureMessage"></param>
    /// <returns></returns>
    public static IResult WhenNotNull<T>(this T @this, Func<T, IResult> whenNotNull, string failureMessage) =>
      @this
    ...
    /// <param name="failureMessage"></param>
    /// <returns></returns>
    public static IResult<TResult> WhenNotNull<T, TResult>(this T @this, Func<T, IResult<TResult>> whenNotNull, string failureMessage) =>
      @this
        .IsNotNull(failureMessage)
        .Bind(t => whenNotNull(t));
    ...
    /// <param name="failureMessage"></param>
    /// <returns></returns>
    public static IResult WhenNotDefault<T>(this T @this, Func<T, IResult> whenNotDefault, string failureMessage) =>
      @this
    ...
    /// <param name="failureMessage"></param>
    /// <returns></returns>
    public static IResult<TResult> WhenNotDefault<T, TResult>(this T @this, Func<T, IResult<TResult>> whenNotDefault, string failureMessage) =>
    @this
      .IsNotDefault(failureMessage)
      .Bind(t => whenNotDefault(t));
  }
